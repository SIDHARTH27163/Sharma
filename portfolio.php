	...
	?>
        ...
        <section class="portfolio_area p_100">
        	<div class="container">
				...
				<?php
try {
    $query = "SELECT * FROM gallery_products where status='1' ORDER BY ID DESC ";
...
?>	
        ...
        while ($row = mysqli_fetch_assoc($query_run)) {
            ?>
       				...
       				<div class="col-md-4 col-6 cake bakery " id="<?php echo $row['category']?>">
       					<div class="portfolio_item">
       						<div class="portfolio_img">
       							<a class="light" href="./admin/<?php echo $row['file_path']?>">
       								<img class="img-fluid" src="./admin/<?php echo $row['file_path']?>" alt="<?php echo $row['original_name']?>">
       							</a>
       						</div>
       						<div class="portfolio_text">
       							<a href="#"><h5><?php echo $row['p_name']?></h5></a>
       						</div>
       					</div>
       				</div>
