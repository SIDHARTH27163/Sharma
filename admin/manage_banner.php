...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <h3 class="text-primary"><i class="fa fa-cogs me-2"></i>Manage Banner</h3>
            </div>
            <!-- Sale & Revenue End -->
            <?php
if (isset($_POST['delete_selected'])) {
    if (!empty($_POST['delete_id'])) {
        ...
        $deleteQuery = "SELECT file_path FROM banner WHERE ID IN ($deleteIDs)";
        ...
        if ($result) {
            ...
            $deleteQuery = "DELETE FROM banner WHERE ID IN ($deleteIDs)";
...
if(isset($_POST["submit"])) {
    ...
    if (empty($service) || empty($file['name']) || empty($desc)) {
        ...
        $sql3 = "CREATE TABLE IF NOT EXISTS banner (
            ID int(50) AUTO_INCREMENT,
            p_name varchar(555) NOT NULL,
        ...
        // $checkIfExists = "SELECT * FROM banner WHERE p_name = '$service'";
        ...
        // } else {
            ...
            $newFileName = 'b' . uniqid() . '.' . $fileExtension; // Create a new unique filename
            ...
            // banners name doesn't exist, proceed with insertion
            $sql4 = "INSERT INTO banner (p_name, file_path, description, original_name) 
...
if (isset($_POST['delete_profile'])) {
    ...
    if ($deleteQuery_run) {
        ...
        echo '<div class="alert alert-danger" role="alert">
            Banner Deleted. ID: ' . $id . '
        </div>';
    } else {
        echo '<div class="alert alert-warning" role="alert">
            Banner Not Deleted. ID: ' . $id . '
        </div>';
    }
}
?>
...
if (isset($_POST['change_status'])) {
    ...
    $statusQuery = "SELECT status FROM banner WHERE ID = $id";
    ...
    if ($statusResult) {
        ...
        $updateQuery = "UPDATE banner SET status = $newStatus WHERE ID = $id";
...
?>
                ...
                <div class="row g-4">
                <div class="col-sm-12 ">
                        <form action="manage_banner.php" enctype="multipart/form-data" name="submit" class="bg-light rounded h-100 p-4" method="post">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Your Added banners</h6>
                        <a href="">Show All</a>
                    </div>
